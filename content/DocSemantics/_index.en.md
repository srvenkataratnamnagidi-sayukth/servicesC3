---
title: "Documentation Semantics"
---
Welcome to the Hugo Documentation Semantics. To write best technical documents, first we should know the syntax of the document managemnt system.
We are using [Hugo](https://gohugo.io/) as Document Management System with theme [Learn](https://themes.gohugo.io/hugo-theme-learn/).
Following sections describe the different components and its syntax and semantics.
